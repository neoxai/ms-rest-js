        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    request = new httpRequest_1.HttpRequest({ method: httpMethod_1.HttpMethod.GET, url: "https://spam.com", headers: {} });
                    return [4 /*yield*/, policy.send(request)];
                case 1:
                    response = _a.sent();
                    assert.deepStrictEqual(request, new httpRequest_1.HttpRequest({ method: httpMethod_1.HttpMethod.GET, url: "https://spam.com", headers: { "User-Agent": "my-user-agent-string" } }));
                    assert.deepStrictEqual(response.request, new httpRequest_1.HttpRequest({ method: httpMethod_1.HttpMethod.GET, url: "https://spam.com", headers: { "User-Agent": "my-user-agent-string" } }));
                    return [2 /*return*/];
            }
        });
    }); });
