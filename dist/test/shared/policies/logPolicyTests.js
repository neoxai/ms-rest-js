    ...
    it("logs requests and responses with no body", function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    response = _a.sent();
                    assert.deepStrictEqual(request, new httpRequest_1.HttpRequest({ method: httpMethod_1.HttpMethod.GET, url: "https://spam.com" }));
                    assert.deepStrictEqual(response.request, new httpRequest_1.HttpRequest({ method: httpMethod_1.HttpMethod.GET, url: "https://spam.com" }));
