...
describe("fetchHttpClient", function () {
    it("should send HTTP requests", function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    request = new httpRequest_1.HttpRequest({ method: httpMethod_1.HttpMethod.GET, url: testUtils_1.baseURL + "/example-index.html" });
    ...
    it("should throw for awaited 404", function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    request = new httpRequest_1.HttpRequest({ method: httpMethod_1.HttpMethod.GET, url: testUtils_1.baseURL + "/nonexistent" });
                    httpClient = new fetchHttpClient_1.FetchHttpClient();
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                ...
                case 3:
                    error_1 = _a.sent();
                    should(error_1).be.instanceof(Error);
                    return [3 /*break*/, 4];
