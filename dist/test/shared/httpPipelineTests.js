...
var fakeHttpClient_1 = require("../shared/fakeHttpClient");
...
describe("HttpPipeline", function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    httpRequest = new httpRequest_1.HttpRequest({ method: httpMethod_1.HttpMethod.GET, url: testUtils_1.baseURL + "/example-index.html" });
    ...
    it("should send requests when using the default HTTP pipeline", function () { return __awaiter(_this, void 0, void 0, function () {
        var httpPipeline, httpRequest, httpResponse, textBody;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    httpPipeline = httpPipeline_1.createDefaultHttpPipeline();
                    httpRequest = new httpRequest_1.HttpRequest({ method: httpMethod_1.HttpMethod.GET, url: testUtils_1.baseURL + "/httpbin-index.html" });
                    return [4 /*yield*/, httpPipeline.send(httpRequest)];
                case 1:
                    ...
                    return [4 /*yield*/, httpResponse.textBody()];
                case 2:
                    textBody = _a.sent();
                    assert(textBody);
