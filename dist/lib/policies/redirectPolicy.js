                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (response && response.headers && response.headers.get("location") &&
                            (response.statusCode === 300 || response.statusCode === 307 || (response.statusCode === 303 && request.method === httpMethod_1.HttpMethod.POST)) &&
                            ...
                            if (response.statusCode === 303) {
                                request.method = httpMethod_1.HttpMethod.GET;
                            }
                        }
                        else {
                            return [3 /*break*/, 3];
