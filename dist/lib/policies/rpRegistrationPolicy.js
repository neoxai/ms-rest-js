...
function rpRegistrationPolicy(retryTimeoutInSeconds) {
    var setRetryTimeoutInSeconds = (retryTimeoutInSeconds == undefined ? 30 : retryTimeoutInSeconds);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        nextRequest.method = httpMethod_1.HttpMethod.POST;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.setEssentialHeaders(nextRequest);
                        nextRequest.url = url;
                        nextRequest.method = httpMethod_1.HttpMethod.GET;
                        return [4 /*yield*/, this._nextPolicy.send(nextRequest)];
                    case 1:
                        response = _a.sent();
                        result = false;
