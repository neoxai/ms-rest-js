...
describe("msrest", function () {
    describe("serializeObject", function () {
        ...
        it("should correctly serialize a Uint8Array Object", function (done) {
            var byteArray = stringToByteArray("Javascript");
    ...
    describe("serialize", function () {
        ...
        it("should correctly serialize a ByteArray Object", function (done) {
            ...
            var byteArray = stringToByteArray("Javascript");
            var base64str = "SmF2YXNjcmlwdA==";
            var serializedObject = Serializer.serialize(mapper, byteArray, "stringBody");
        ...
        it("should throw an error when given an invalid ISO 8601 duration", function () {
            var mapper = { type: { name: "TimeSpan" }, required: false, serializedName: "TimeSpan" };
            var duration = "P123Z42DT22H14M12.011S";
            (function () { return Serializer.serialize(mapper, duration, "dateTimeObj"); }).should.throw(/must be a string in ISO 8601 format/);
        });
    ...
    describe("deserialize", function () {
        ...
        it("should correctly deserialize a pageable type without nextLink", function (done) {
            var client = new TestClient("http://localhost:9090");
            var mapper = Mappers.ProductListResult;
            var responseBody = {
                value: [
                    {
                        id: 101,
        ...
        it("should correctly deserialize a pageable type with nextLink", function (done) {
            var client = new TestClient("http://localhost:9090");
            var mapper = Mappers.ProductListResultNextLink;
            var responseBody = {
                value: [
                    {
                        id: 101,
        ...
        it("should deserialize headerCollectionPrefix", function () {
            ...
            var actual = Serializer.deserialize(mapper, rawHeaders, "headers");
