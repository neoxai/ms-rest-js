...
describe("axiosHttpClient", function () {
    it("should send HTTP requests", function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    request = new WebResource(baseURL + "/example-index.html", "GET");
    ...
    it("should return a response instead of throwing for awaited 404", function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    request = new WebResource(baseURL + "/nonexistent", "GET");
                    httpClient = new AxiosHttpClient();
                    return [4 /*yield*/, httpClient.sendRequest(request)];
                case 1:
                    response = _a.sent();
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        request = new WebResource(baseURL + "/fileupload", "POST", new Uint8Array(1024 * 1024 * 10), undefined, undefined, true, controller.signal);
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        client = new AxiosHttpClient();
                        request1 = new WebResource(baseURL + "/set-cookie");
                        return [4 /*yield*/, client.sendRequest(request1)];
                    case 1:
                        _a.sent();
                        request2 = new WebResource(baseURL + "/cookie");
                        return [4 /*yield*/, client.sendRequest(request2)];
                    case 2:
                        response2 = _a.sent();
                        should(response2.headers.get("Cookie")).equal("data=123456");
                        request3 = new WebResource(baseURL + "/cookie", "GET", undefined, undefined, { Cookie: "data=abcdefg" });
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        buf = new Uint8Array(1024 * 1024 * 1);
                        request = new WebResource(baseURL + "/fileupload", "POST", buf, undefined, undefined, true, undefined, function (ev) {
                            uploadNotified = true;
    ...
    it("should parse a JSON response body", function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        request = new WebResource(baseURL + "/json");
                        client = new AxiosHttpClient();
                        return [4 /*yield*/, client.sendRequest(request)];
                    case 1:
                        response = _a.sent();
    ...
    it("should parse a JSON response body with a charset specified in Content-Type", function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        request = new WebResource(baseURL + "/json-charset");
                        client = new AxiosHttpClient();
                        return [4 /*yield*/, client.sendRequest(request)];
                    case 1:
                        response = _a.sent();
    ...
    it("should parse a JSON response body with an uppercase Content-Type", function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        request = new WebResource(baseURL + "/json-uppercase-content-type");
                        client = new AxiosHttpClient();
                        return [4 /*yield*/, client.sendRequest(request)];
                    case 1:
                        response = _a.sent();
    ...
    it("should parse a JSON response body with a missing Content-Type", function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        request = new WebResource(baseURL + "/json-no-content-type");
                        client = new AxiosHttpClient();
                        return [4 /*yield*/, client.sendRequest(request)];
                    case 1:
                        response = _a.sent();
