...
var AxiosHttpClient = /** @class */ (function () {
    function AxiosHttpClient() {
        this.cookieJar = isNode ? new tough.CookieJar() : undefined;
    }
                ...
                switch (_b.label) {
                    ...
                    case 7:
                        ...
                        operationResponse = {
                            ...
                            status: res.status,
                            headers: headers,
                            readableStreamBody: httpRequest.rawResponse && isNode ? res.data : undefined,
                            blobBody: !httpRequest.rawResponse || isNode ? undefined : function () { return res.data; }
                        };
                    ...
                    case 9:
                        ...
                        try {
                            ...
                            e = new RestError(msg, errCode, res.status, httpRequest, operationResponse, res.data);
                    ...
                    case 14:
                        ...
                        e = new RestError(msg, errCode, res.status, httpRequest, operationResponse, operationResponse.bodyAsText);
                        return [2 /*return*/, Promise.reject(e)];
