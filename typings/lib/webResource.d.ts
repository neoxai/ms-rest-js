...
export declare class WebResource {
    ...
    constructor(url?: string, method?: HttpMethods, body?: any, query?: {
        ...
        [key: string]: any;
    } | HttpHeaders, rawResponse?: boolean, abortSignal?: AbortSignal, onUploadProgress?: (progress: TransferProgressEvent) => void, onDownloadProgress?: (progress: TransferProgressEvent) => void);
    /**
